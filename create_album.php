...
<div class="center">
<h3 style="margin-top:60px;">Create Album</h3>
...
<form class="myForm" method="post" enctype="multipart/form-data" action="">
...
<p>
<label>Name 
<input type="text" name="album_name"  maxlength="55" required />
</label> 
</p>
...
<p>
<label>Description 
<textarea name="album_description" rows="6" cols="35" maxlenght="255"></textarea>
</label>
</p>
